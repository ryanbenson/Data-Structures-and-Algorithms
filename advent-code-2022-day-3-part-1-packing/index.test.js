...
const { getItemSum } = require('./index');

test('#getItemSum when given a valid sample', t => {
...
CrZsJsPPZsGzwwsLwLmpwMDw`;
    const result = getItemSum(sample);
    const expected = 157;
    t.is(result, expected);
});


test('#getItemSum when given a long valid sample', t => {
    const sample = `PPZTzDhJPLqPhqDTqrwQZZWbmCBMJMcsNmCBFWmMcsNb
